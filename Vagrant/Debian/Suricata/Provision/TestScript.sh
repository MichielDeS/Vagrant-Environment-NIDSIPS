...
# Define the Suricata service name
...
# Delay to allow Suricata time to start
sleep 10
...
# Add CSV headers to the log file
...
for ((i=0; i<iterations; i++)); do
    ...
    echo "Suricata is running. Proceeding with memory monitoring."
